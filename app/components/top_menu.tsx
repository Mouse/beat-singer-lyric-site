...
export default function TopMenu() {
    return (
        <nav className="bg-gray-800 mix-blend-hard-light fixed w-full z-20 top-0 inset-s-0 border-b border-default">
            <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="../../icon.png" className="h-7" alt="BeatLyricist Logo" />
                    <span className="self-center text-xl text-heading font-semibold whitespace-nowrap">BeatLyricist</span>
                </a>
